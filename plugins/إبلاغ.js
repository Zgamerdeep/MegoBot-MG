...
m.reply(`*[ ✔️ ] تم إبلاغ المطور وإنشاء الله سيكون في خدمتك في أسرع وقت 🐦🫶🏻❤️*`)
}
handler.help = ['reporte', 'request'].map(v => v + ' <teks>')
handler.tags = ['info']
handler.command = /^(report|بلاغ|بلغ|إبلاغ|bug|report-owner|reportes)$/i
